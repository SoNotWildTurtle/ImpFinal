...
ROADMAP_CHECKER_PATH = ROOT / "self-improvement" / "imp-roadmap-checker.py"
...
def perform_metacognitive_analysis(net: SimpleNeuralNetwork) -> None:
    ...
    spec_rm = importlib.util.spec_from_file_location("imp_roadmap_checker", ROADMAP_CHECKER_PATH)
    rm_module = importlib.util.module_from_spec(spec_rm)
    spec_rm.loader.exec_module(rm_module)
    roadmap = rm_module.check_progress()
    summary = {
